...
public class Show_myFriends extends Fragment implements View.OnClickListener {
    ...
    private ArrayAdapterForShowMyFriends mAdapter;
    ...
    class getMyFriends extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected ArrayList<String> doInBackground(Void... voids) {
            ...
            dbRef.child(mAuth.getCurrentUser().getUid()).child("userFriends").addValueEventListener( new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (friends.size()==0) {
                        progressBar.setVisibility( View.GONE );
                        noFriends.setText("No Found Friends");
                        ...
                        if (recyclerView.getAdapter() == null) {
                            mAdapter = new ArrayAdapterForShowMyFriends( getContext(), friends );
