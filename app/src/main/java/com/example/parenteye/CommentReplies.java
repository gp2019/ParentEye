...
public class CommentReplies {
    ...
    public CommentReplies(String commentRepliesid, String userId, String commentId, String replycontent, boolean hasimage, String imageid, Time time,int countOfLike) {
    ...
    public void setCountOfLike(int CountOfLike){this.CountOfLike=CountOfLike;}

    public int getCountOfLike() {return CountOfLike;}
